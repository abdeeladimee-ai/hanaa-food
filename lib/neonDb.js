...
create table if not exists public.order_abuse_guard (
...
create index if not exists order_abuse_guard_blocked_idx
  on public.order_abuse_guard (blocked_until)
...
create table if not exists public.staff_accounts (
  ...
  role text not null check (role in ('SNACK','LIVREUR')),
  branch_id text,
  branch_name text,
...
create index if not exists staff_accounts_role_active_idx
  on public.staff_accounts (role, active);
`;
